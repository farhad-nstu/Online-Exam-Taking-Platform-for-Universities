    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="breadcomb-wp">
                ...
                <div class="breadcomb-ctn">
                    <h2>Topic List</h2>
                    <p>View, add, edit or delete course topics.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-3">
            <div class="breadcomb-report">
                <a class="float-right btn btn-sm btn-success admin-btn" href="{{route('topic.create')}}">Add New
                    Topic</a>
            </div>
        </div>
    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="d-flex justify-content-center">
                                                        <li class="mr-3"><a href="{{route('topic.edit',[$topic->id])}}"
                                                                class="text-secondary"><i class="notika-icon notika-edit"></i></a></li>

                                                        <li class="mr-3"><a href="#" class="text-danger"
                                                                onclick="event.preventDefault(); document.getElementById('delete-form-{{ $topic->id }}').submit();"><i
                                                                    class="notika-icon notika-trash"></i></a></li>

                                                        <form id="delete-form-{{ $topic->id }}"
                                                            action="{{ route('topic.destroy',$topic->id) }}" method="POST"
                                                            style="display: none;">
                                                            @csrf @method('delete')
                                                        </form>
